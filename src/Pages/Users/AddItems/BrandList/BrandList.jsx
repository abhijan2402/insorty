...
const BrandList = () => {
  ...
  const deleteBrand = (id) => {
    fetch(
      "https://insorty-api.onrender.com/admin/deleteGlobalLiquorFromAllShops",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
                    ...
                    <React.Fragment key={item._id}>
                      <tr>
                        <th
                          ...
                          rowSpan={item.sizes.length + 1}
                        >
                          {index + 1}
                        </th>
                        <td rowSpan={item.sizes.length + 1}>
                          {item.brandName}
                        </td>
                        <td
                        ...
                        <td rowSpan={item.sizes.length + 1}>
                          {item?.type === "DESHIRML" ? "DESHI/RML" : item?.type}
                        </td>
                        <th
                          className="text-center align-center item-center text-[1.7rem]"
                          rowSpan={item.sizes.length + 1}
                        >
