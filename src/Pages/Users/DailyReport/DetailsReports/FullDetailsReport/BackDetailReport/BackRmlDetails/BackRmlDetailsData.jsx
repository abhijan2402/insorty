  ...
  return (
    <>
      <tr key={index}>
        ...
        <td>
          {(
            (Number(RmlData.purchaseShopRate.$numberDecimal) +
              Number(RmlData.purchaseOutSideRate.$numberDecimal)) /
            2
          ).toFixed(2)}
        </td>
        ...
        <td>
          {(Number(RmlData.purchaseShopRate.$numberDecimal || 0) || 0).toFixed(
            2
          )}
        </td>
        ...
        <td>
          {(
            Number(RmlData.purchaseOutSideRate.$numberDecimal || 0) || 0
          ).toFixed(2)}
        </td>
        ...
        <td>
          {(
            Number(
              Number(RmlData.amount ? RmlData.amount.$numberDecimal : 0) /
                RmlData.sales
            ) || 0
          ).toFixed(2)}
        </td>
        <td>
          {(
            Number(RmlData.amount ? RmlData.amount.$numberDecimal : 0) || 0
          ).toFixed(2)}
        </td>
      </tr>
    </>
