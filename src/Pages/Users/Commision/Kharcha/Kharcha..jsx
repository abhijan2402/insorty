  ...
  return (
    <section className="py-4 px-4">
      <div className="title">
        ...
        <div ref={front}>
          <div>
            <h2 className="font-bold md:text-[1.5rem] text-center"> खर्चा</h2>
                  ...
                  <tbody>
                    {commitsonData.length &&
                      filteredData.map((burger, index) => {
                        ...
                        const filterKharchaForm = (type) => {
                          let filtered = entries.filter((item) => {
                            return item.type === "KHARCHA";
                          });
                          return filtered;
                        };
                        const KharchaForm = filterKharchaForm("KHARCHA");

                        return (
                          <>
                            {KharchaForm.map((item) => {
