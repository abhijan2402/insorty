        ...
        <table className="removeCommonWSpace">
          ...
          <tbody>
            <tr>
              ...
              <td className="price">{openingStock ? Number(openingStock).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">2</th>
              <td className="commonText">माल खरीद/bought</td>
              <td className="price">{bought ? Number(bought).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">3</th>
              <td className="commonText">माल शेष/अन्तिम स्टॉक/closingStock</td>
              <td className="price">{closingStock ? Number(closingStock).toFixed(2) : "0"}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="price">{totalExpenses ? Number(totalExpenses).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">7</th>
              <td className="commonText">बचत/savings</td>
              <td className="price">{savings ? Number(savings).toFixed(2) : "0"}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="price">{realSavings ? Number(realSavings).toFixed(2) : "0"}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="price">{totalOld ? Number(totalOld).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              ...
              <td className="price">
                {realSavings + refundRecoveryOld + totalOld
                  ? Number(realSavings + refundRecoveryOld + totalOld).toFixed(2)
                  : "0"}
              </td>
            </tr>
            <tr>
              ...
              <td className="price">{extraBorrowed ? Number(extraBorrowed).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">14</th>
              <td className="commonText">अधिक जमा/extraDeposits</td>
              <td className="price">{extraDeposits ? Number(extraDeposits).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">15</th>
              <td className="commonText">कैश ऑन हैण्ड/cashOnHand</td>
              <td className="price">{cashOnHand ? Number(cashOnHand).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">16</th>
              <td className="commonText">रिजर्व रकम/reservedCash</td>
              <td className="price">{reservedCash ? Number(reservedCash).toFixed(2) : "0"}</td>
            </tr>
            <tr>
              <th className="commonText">17</th>
              <td className="commonText">शेष रकम/remainingCash</td>
              <td className="price">{remainingCash ? Number(remainingCash).toFixed(2) : "0"}</td>
            </tr>
          </tbody>
        </table>
      </div>
