...
const useMainInvestmentHooks = () => {
  ...
  useEffect(() => {
    fetch('https://insorty-api.onrender.com/shop/getMainInvestmentPage', {
      ...
      .then(invest => {setData(invest.data); console.log(invest); setLoading(false)})
  ...
  const handleInvestmentChange = useCallback((field, newValue) => {
  ...
  const handleTotalChange = useCallback((newValue) => {
  ...
  const handleBelongingChange = useCallback((index, field, newValue) => {
    setData(prevData => ({
      ...prevData,
      mainInvest: {
        ...prevData.mainInvest,
  ...
  const handleFeesChange = useCallback((index, field, newValue) => {
    setData(prevData => ({
      ...prevData,
      mainInvest: {
        ...prevData.mainInvest,
