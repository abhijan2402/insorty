                      ...
                      .map((prevLone, index) => {
                        ...
                        return (
                          <tr id="scrollableDiv">
                            ...
                            <td>
                              {ShopType === "SHOP" && (
                                <Link to={`/user/previousloan/details/${id}`}>
                                  {prevLone?.name}
                                </Link>
                              )}
                            ...
                            <td>
                              {(Number(prevLone?.totalDebits) || 0) -
                                (Number(prevLone?.totalDeposits) || 0)}
                            </td>
                    ...
                    <td>
                      {parties &&
                        ...
                        parties
                          ...
                          .reduce(
                            (total, curr) =>
                              (total = total + Number(curr.totalDebits)),
                            0
                          )}
                    </td>
                    <td>
                      {parties &&
                        ...
                        parties
                          ...
                          .reduce(
                            (total, curr) =>
                              (total = total + Number(curr.totalDeposits || 0)),
                            0
                          )}
                    </td>
                    <td>
                        ...
                        parties
                          ...
                          .reduce(
                            (total, curr) =>
                              (total =
                                total +
                                (Number(curr.totalDebits || 0) -
                                  Number(curr.totalDeposits || 0))),
                            0
                          )}
                    </td>
                  </tr>
