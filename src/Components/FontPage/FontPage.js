           ...
           <div id="center">
                ...
                <div id="continue">
                    <form method="post" action="#">
                        <button className='btn' type="submit" onsubmit="">CONTINUE</button> 
                        {/* //handleAccountType?() */}
                    </form>
                </div>               
                <h4>Already Have An Account&#63;<i></i><Link to='/login'>Login</Link>   </h4>   
            </div>
