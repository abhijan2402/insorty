...
const handleAdd = async (event) =>{
    ...
    await axios.post("https://beer-shop.onrender.com/auth/login", { role: role, accountId: name, password})
    .then((response=>{
                ...
                <form onSubmit={handleAdd} >
                    ...
                    <div className="label_n_inp">
                        ...
                        <div>
                            ...
                            <input name='password' className='inputs'  type="password" id="password" />
                        </div>
                    </div>
