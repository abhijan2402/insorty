...
function useGetDailyReport() {
    ...
    const { data: PurchaseOutsideData, isLoading: PurchaseOutsideLoaded, PurchaseOutsideRefetch } = useQuery({
    ...
    const { data: TotalExpensesData, isLoading: TotalExpensesLoaded, TotalExpensesRefetch } = useQuery({
    ...
    const { data: BorrowedCashReturnData, isLoading: BorrowedCashReturnLoaded, BorrowedCashReturnRefetch } = useQuery({
    ...
    const { data: PurchaseBorrowData, isLoading: PurchaseBorrowLoaded, PurchaseBorrowRefetch } = useQuery({
    ...
    const { data: BorrowedData, isLoading: BorrowedDataLoaded, BorrowedDataRefetch } = useQuery({
    ...
    const { data: FinalReportData, isLoading: FinalReportDataLoaded, FinalReportDataRefetch } = useQuery({
    ...
    const { data: FrontPageData, isLoading: FrontPageDataLoaded, FrontPageDataRefetch } = useQuery({
